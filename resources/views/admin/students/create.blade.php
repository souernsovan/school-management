<x-app-layout>
    ...
    <x-slot name="header">Create Student</x-slot>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <form method="POST" action="{{ route('students.store') }}"
                ...
                <div class="bg-slate-50 px-6 py-4 border-b border-slate-100">
                    <h2 class="text-base font-bold text-slate-800">New Student Information</h2>
                    <p class="text-sm text-slate-500 mt-0.5">Add a new student to the school system</p>
                </div>
                ...
                <div class="p-5 sm:p-6 space-y-5">
                    ...
                    <div class="rounded-xl border border-slate-200 bg-slate-50/50 p-4 space-y-3">
                        ...
                        <!-- User picker -->
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1">Link to User Account <span class="text-slate-400 font-normal text-xs">(optional)</span></label>
                            ...
                            <p class="text-[11px] text-slate-400 mt-1">Selecting a user will auto-fill the email below and link their portal access.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input name="email" type="email"
                                       ...
                                       class="w-full rounded-xl border focus:border-blue-500 focus:ring-blue-500 text-sm pr-10"
                                       placeholder="Enter email address">
                                <span x-show="linked"
                                      class="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1 text-emerald-600 text-xs font-semibold">
                    ...
                    <div>
                        ...
                        <select name="class_id" class="w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500 text-sm">
                            ...
                            <option value="{{ $class->id }}" {{ old('class_id', $selectedClassId ?? null) == $class->id ? 'selected' : '' }}>
