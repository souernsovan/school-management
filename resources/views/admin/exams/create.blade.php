    ...
    <div class="p-4 sm:p-6">
        ...
        <div class="max-w-2xl mx-auto space-y-5">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-xl font-bold text-slate-800">Create New Exam</h2>
                    <p class="text-xs text-slate-400 mt-0.5">Fill in the details below to schedule an exam</p>
                </div>
            </div>

            <form method="POST" action="{{ route('exams.store') }}" x-data="examForm()" class="space-y-4">
                @csrf
                ...
                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                    ...
                    <div class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        {{-- Total Marks --}}
                        <div x-data="{ marks: {{ old('total_marks', 100) }} }">
                            <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wide mb-1.5">
                ...
                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                    ...
                    <div class="p-5">
                        <textarea name="description" rows="3"
                                  ...
                                  class="w-full rounded-xl border px-3 py-2.5 text-sm text-slate-800 placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition resize-none {{ $errors->has('description') ? 'border-red-400 bg-red-50' : 'border-slate-200 bg-slate-50' }}">{{ old('description') }}</textarea>
                        @error('description')
