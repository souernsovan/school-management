<x-app-layout>
    ...
    <div class="p-4 sm:p-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 max-w-3xl mx-auto p-4 sm:p-6">
            <h2 class="text-lg font-bold text-slate-800 mb-5">Edit Exam</h2>
            ...
            <form method="POST" action="{{ route('exams.update', $exam) }}" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="number" name="total_marks" value="{{ old('total_marks', $exam->total_marks) }}" min="1" max="1000" required
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                              class="w-full rounded-xl border-slate-200 text-sm focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-400 @enderror">{{ old('description', $exam->description) }}</textarea>
