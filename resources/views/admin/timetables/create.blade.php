        ...
        <div class="max-w-2xl mx-auto">
            ...
            <form method="POST" action="{{ route('timetables.store') }}"
                ...
                <div class="bg-slate-50 px-6 py-4 border-b">
                    <h2 class="text-lg font-semibold text-slate-800">Add Timetable Entry</h2>
                    <p class="text-sm text-blue-500 mt-0.5">Schedule a class, exam, or break</p>
                </div>
                ...
                <div class="p-4 sm:p-6 space-y-5">
                        ...
                        <div class="mt-2 grid grid-cols-3 gap-3">
                            <label class="cursor-pointer">
                                <input type="radio" name="entry_type" value="class" class="sr-only peer"
                                       {{ old('entry_type','class') === 'class' ? 'checked' : '' }}
                                       x-model="entryType">
                    ...
                    <div x-show="entryType === 'exam'" x-cloak class="space-y-3">
                        ...
                        <div>
                            ...
                            <input type="number" name="total_marks" value="{{ old('total_marks', 100) }}" min="1" max="1000"
                                   :disabled="entryType !== 'exam'"
                                   class="mt-1 w-full rounded-xl border-slate-300 focus:border-red-500 focus:ring-red-500">
                            @error('total_marks')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                        </div>

                        <input type="hidden" name="exam_id" value="" :disabled="entryType !== 'exam'">
                    ...
                    <div x-show="entryType === 'break'" x-cloak>
                        ...
                        <input type="text" name="title" value="{{ old('title', 'Break') }}"
