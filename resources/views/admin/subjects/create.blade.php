        ...
        <div class="max-w-3xl mx-auto">
            <form method="POST" action="{{ route('subjects.store') }}"
                ...
                <div class="px-6 py-4 border-b border-slate-100">
                    <h2 class="text-lg font-semibold text-slate-800">Create Subject</h2>
                    <p class="text-sm text-slate-500">Add a new subject</p>
                </div>
                ...
                <div class="p-4 sm:p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input name="credit" type="number" min="1" value="{{ old('credit', 1) }}"
                               class="mt-1 w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500">
                ...
                <div class="bg-slate-50 px-6 py-4 border-t border-slate-100 flex justify-end gap-3">
                    ...
                    <button type="submit" class="px-6 py-2 rounded-xl bg-blue-600 text-white hover:bg-blue-700 text-sm font-medium shadow-sm">Create Subject</button>
                </div>
